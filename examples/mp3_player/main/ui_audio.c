...
void ui_audio_start(void)
{
    ...
    lv_label_set_text_static(label_play_pause, LV_SYMBOL_PAUSE);
    lv_obj_set_style_text_font(label_play_pause, &lv_font_montserrat_26, LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(label_prev, &lv_font_montserrat_26, LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(label_next, &lv_font_montserrat_26, LV_STATE_DEFAULT);
    ...
    lv_obj_align(volume_slider, LV_ALIGN_BOTTOM_MID, 0, -50);
    lv_slider_set_range(volume_slider, 0, 85);
    lv_slider_set_value(volume_slider, 75, LV_ANIM_ON);
    ...
    lv_obj_align(lab_title, LV_ALIGN_TOP_MID, 0, 50);
